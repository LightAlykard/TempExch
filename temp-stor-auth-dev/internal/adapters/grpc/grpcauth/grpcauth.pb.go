...
func (x *MessageJWT) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageJWT) ProtoMessage() {}

func (x *MessageJWT) ProtoReflect() protoreflect.Message {
	mi := &file_grpcauth_proto_msgTypes[0]
...
// Deprecated: Use MessageJWT.ProtoReflect.Descriptor instead.
func (*MessageJWT) Descriptor() ([]byte, []int) {
	return file_grpcauth_proto_rawDescGZIP(), []int{0}
}

func (x *MessageJWT) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *MessageJWT) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *ReplyJWT) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplyJWT) ProtoMessage() {}

func (x *ReplyJWT) ProtoReflect() protoreflect.Message {
	mi := &file_grpcauth_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplyJWT.ProtoReflect.Descriptor instead.
func (*ReplyJWT) Descriptor() ([]byte, []int) {
	return file_grpcauth_proto_rawDescGZIP(), []int{1}
}

func (x *ReplyJWT) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_grpcauth_proto_rawDesc = []byte{
	...
	0x22, 0x3a, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4a, 0x57, 0x54, 0x12, 0x18,
	0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79,
